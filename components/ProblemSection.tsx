    ...
    <section id="problem" className="py-24 bg-dark-900 border-t border-slate-800">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight px-4 sm:px-0">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-base md:text-lg px-2">
             졸업과 함께 포맷되는 연구실의 노하우, USB에 담겨 사라지는 기밀 데이터.
             <span className="block mt-1 sm:inline sm:mt-0"> 연구 자산, 언제까지 개인의 기억과 양심에만 맡기시겠습니까?</span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="group relative rounded-2xl overflow-hidden bg-dark-800 border border-slate-700 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-brand-500/30">
              ...
              <div className="absolute bottom-4 left-4 right-4 z-10">
                  <div className="bg-slate-900/95 backdrop-blur-md rounded-lg border border-slate-600 shadow-xl overflow-hidden">
                      <div className="bg-slate-800 px-3 py-2 flex items-center justify-between border-b border-slate-700">
                          <span className="text-[10px] sm:text-xs text-slate-300 flex items-center gap-2 font-mono">
                      ...
                      <div className="p-3 sm:p-4 flex items-start gap-3">
                          ...
                          <div>
                              <p className="text-xs sm:text-sm font-bold text-white mb-0.5 sm:mb-1">데이터를 찾을 수 없습니다</p>
                              <p className="text-[9px] sm:text-xs text-slate-400 font-mono mb-2">
                                Last modified: 2 years ago by Dr.Kim
                              </p>
                              <div className="inline-flex items-center gap-1 text-[9px] text-red-300 bg-red-500/10 px-2 py-0.5 rounded border border-red-500/20">
            ...
            <div className="p-6 sm:p-8 relative z-10 bg-dark-800 border-t border-slate-700">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-orange-500/10 rounded-lg text-orange-500">
                  <Search size={24} />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-white">연구 지식의 블랙홀</h3>
              </div>
              <p className="text-slate-300 font-medium mb-2 text-sm sm:text-base">
          ...
          <div className="group relative rounded-2xl overflow-hidden bg-dark-800 border border-slate-700 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-brand-500/30">
                 ...
                 <div className="bg-slate-900/95 backdrop-blur-md rounded-lg border border-slate-600 shadow-xl overflow-hidden">
                    ...
                    <div className="p-3 sm:p-4">
                        <div className="flex justify-between items-center mb-2">
                            <span className="text-[10px] sm:text-xs text-white font-medium truncate max-w-[60%]">Project_Falcon_Design.cad</span>
                            <span className="text-[10px] sm:text-xs text-brand-400 font-bold">Copying...</span>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                             ...
                             <span className="text-[10px] sm:text-xs text-red-400 font-bold animate-pulse">외부 반출 승인되지 않음</span>
                        </div>
                    </div>
                  </div>
              </div>
            ...
            <div className="p-6 sm:p-8 relative z-10 bg-dark-800 border-t border-slate-700">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">보안 수동 관리의 한계</h3>
              </div>
              <p className="text-slate-300 font-medium mb-2 text-sm sm:text-base">
